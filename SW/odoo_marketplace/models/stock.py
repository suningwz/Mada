...
class StockMove(models.Model):
    ...
    def _get_new_picking_values(self):
        ...
        mp_seller_obj = self.product_id.marketplace_seller_id
        if mp_seller_obj:
            vals.update({"marketplace_seller_id": mp_seller_obj.id})
        return vals
    ...
    def _search_picking_for_assignation(self):
        ...
        mp_seller_obj = self.product_id.marketplace_seller_id
        if mp_seller_obj:
            domain.append(('marketplace_seller_id', '=', mp_seller_obj.id))
        else:
