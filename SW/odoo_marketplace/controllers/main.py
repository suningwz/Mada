...
class AuthSignupHome(odoo.addons.web.controllers.main.Home):
    ...
    def web_login(self, *args, **kw):
        ...
        if request.session.uid:
            if request.httprequest.method == 'POST' and not request.env.user.sudo().has_group('base.group_user') and request.env.user.sudo().has_group('odoo_marketplace.marketplace_draft_seller_group') and request.env.user.partner_id.seller:
