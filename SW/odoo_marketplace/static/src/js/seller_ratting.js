                ...
                .then(function (result)
                {
                    if(result){
                        if(typeof(result) == 'boolean') {
                            ...
                            if(recommend_no.hasClass("btn-success disabled")){
                                recommend_no.removeClass("btn-success disabled");
                ...
                .then(function (result)
                {
                    if(result){
                        if(typeof(result) == 'boolean') {
                            $this.removeClass("btn-info");
                            $this.addClass("btn-success disabled");
                            if(recommend_yes.hasClass("btn-success disabled")){
                                recommend_yes.removeClass("btn-success disabled");
