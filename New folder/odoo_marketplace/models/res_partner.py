...
class ResPartner(models.Model):
    ...
    seller_fields.extend(['shipping_policy','return_policy','profile_msg'])
    ...
    def write(self, vals):
        ...
        new_seller = False
        if not self.env.user.has_group('odoo_marketplace.marketplace_seller_group'):
            for res in seller_fields:
                if res in vals:
                    vals.pop(res)
